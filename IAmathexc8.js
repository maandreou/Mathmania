...
var getCategory = function(mean) {
  ...
  if (mean < 2) {
    ...
    c= "Maybe you should consider reviewing strategies on how to divide in your head. Take a look at the video under the review section to refresh your memory and come back to keep practicing!";
  }
  else if (mean> 9){
