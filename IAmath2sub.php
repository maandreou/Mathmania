...
?>
    ...
    <div class="w3-container w3-center w3-blue" style="padding: 90px 16px">
        <h1 class="w3-margin w3-xxlarge"> Grade 2 Subtraction Exercise </h1>
    </div>

    <br>
    <p class="math_add_2 w3-center" style="color:white;"><b> Instructions </b> <br> <a class="math_add2"> When you are
        ...
        <div class="column">
            <div class="card_div">
                <div class="container_div w3-center">
                    ...
                    <script type="text/javascript" src="IAmathexc4.js"></script>
                </div>
            </div>
        </div>
    </div>
