...
?>
    ...
    <div class="w3-container w3-center w3-blue" style="padding: 90px 16px">
        <h1 class="w3-margin w3-xxlarge"> Grade 1 Addition Exercise </h1>
    </div>

    <br>
    <p class="math_add w3-center" style="color:white;"><b> Instructions </b> <br> <a class="math_add2"> When you are ready to start playing, press start and submit your answers using the Enter key. When you have
        ...
        <div class="column">
            <div class="card_div">
                <div class="container_div w3-center">
                    ...
                    <button id="refresh" class="refresh2_btn"> REPLAY</button> <!--id="refresh" -->
    ...
    <script type="text/javascript" src="IAmathexc1.js"></script>
