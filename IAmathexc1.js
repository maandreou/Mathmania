/***** Addition Grade 1 *****/
/***** get all html DOM (document object model) elements *****/
...
//answer was correct so no need for 'try again'
        ...
        if (count == 2) {
            ...
            document.getElementById("stop").style.visibility = "hidden";
            document.getElementById("refresh").style.visibility = "visible";
            document.getElementById('refresh').className = 'refresh2_btn';
            document.getElementById("in").style.visibility = "hidden";
            document.getElementById("qanswered").style.visibility = "hidden";
            document.getElementById("text").style.visibility = "hidden";
        } else {
...
var getCategory = function (mean) {
    ...
    if (mean < 2) {
        ...
        c = "Maybe you should consider reviewing strategies on how to add in your head. Take a look at the video under the review section to refresh your memory and come back to keep practicing!";
    }
    else if (mean > 8) {
